 ...
 */
#ifndef EMBEDDEDFILEREGISTERSERVERDEBUG_H
#define EMBEDDEDFILEREGISTERSERVERDEBUG_H
...
namespace bin2cpp
{
  ...
  const File & getRegisterServerDebugFile();
}; //bin2cpp

#endif //EMBEDDEDFILEREGISTERSERVERDEBUG_H
