 ...
 */
#ifndef EMBEDDEDFILEUNREGISTERSERVERDEBUG_H
#define EMBEDDEDFILEUNREGISTERSERVERDEBUG_H
...
namespace bin2cpp
{
  ...
  const File & getUnregisterServerDebugFile();
}; //bin2cpp

#endif //EMBEDDEDFILEUNREGISTERSERVERDEBUG_H
