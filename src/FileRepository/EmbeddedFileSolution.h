 ...
 * Source code for file 'DCOMPLUGIN_COMPONENT_NAME.sln', last modified 1552228002.
 * Do not modify this file.
 */
#ifndef EMBEDDEDFILESOLUTION_H
#define EMBEDDEDFILESOLUTION_H
...
namespace bin2cpp
{
  ...
  const File & getSolutionFile();
}; //bin2cpp

#endif //EMBEDDEDFILESOLUTION_H
