...
namespace bin2cpp
{
  ...
  public:
    ...
    virtual const char * getSegment(size_t iIndex, size_t & oLength)
    {
      ...
      oLength = 78;
      buffer = "@echo off\x0d\x0a\".\\Debug\\DCOMPLUGIN_COMPONENT_NAMEServer.exe\" /unregserver\x0d\012pause\x0d\x0a"; if (iIndex == index) return buffer; index++;
      oLength = 0;
      return NULL;
    }
    virtual const char * getMd5() { return "8d88d10d9f20d2a18f3eb8b42f11d108"; }
  ...
  File & getUnregisterServerDebugFile() { static UnregisterServerDebugFile _instance; return _instance; }
}; //bin2cpp
