 ...
 * Source code for file 'DCOMPLUGIN_COMPONENT_NAMEClient.vcxproj', last modified 1552228002.
 * Do not modify this file.
 */
#ifndef EMBEDDEDFILECLIENTPROJECT_H
#define EMBEDDEDFILECLIENTPROJECT_H
...
namespace bin2cpp
{
  ...
  const File & getClientProjectFile();
}; //bin2cpp

#endif //EMBEDDEDFILECLIENTPROJECT_H
