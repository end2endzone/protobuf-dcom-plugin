 ...
 * Source code for file 'Registry.cpp', last modified 1552228003.
 * Do not modify this file.
 */
#ifndef EMBEDDEDFILEREGISTRYCPP_H
#define EMBEDDEDFILEREGISTRYCPP_H
...
namespace bin2cpp
{
  ...
  const File & getRegistryCppFile();
}; //bin2cpp

#endif //EMBEDDEDFILEREGISTRYCPP_H
