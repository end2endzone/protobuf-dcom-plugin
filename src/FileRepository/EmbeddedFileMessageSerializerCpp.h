 ...
 */
#ifndef EMBEDDEDFILEMESSAGESERIALIZERCPP_H
#define EMBEDDEDFILEMESSAGESERIALIZERCPP_H
...
namespace bin2cpp
{
  ...
  const File & getMessageSerializerCppFile();
}; //bin2cpp

#endif //EMBEDDEDFILEMESSAGESERIALIZERCPP_H
