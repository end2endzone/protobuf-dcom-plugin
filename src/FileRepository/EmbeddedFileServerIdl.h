 ...
 * Source code for file 'DCOMPLUGIN_COMPONENT_NAMEServer.idl', last modified 1552247129.
 * Do not modify this file.
 */
#ifndef EMBEDDEDFILESERVERIDL_H
#define EMBEDDEDFILESERVERIDL_H
...
namespace bin2cpp
{
  ...
  const File & getServerIdlFile();
}; //bin2cpp

#endif //EMBEDDEDFILESERVERIDL_H
