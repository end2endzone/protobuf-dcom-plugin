 ...
 * Source code for file 'DCOMPLUGIN_COMPONENT_NAMEServer.h', last modified 1552247129.
 * Do not modify this file.
 */
#ifndef EMBEDDEDFILESERVERHEADER_H
#define EMBEDDEDFILESERVERHEADER_H
...
namespace bin2cpp
{
  ...
  const File & getServerHeaderFile();
}; //bin2cpp

#endif //EMBEDDEDFILESERVERHEADER_H
