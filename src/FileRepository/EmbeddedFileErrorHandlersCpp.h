 ...
 * Source code for file 'ErrorHandlers.cpp', last modified 1552247130.
 * Do not modify this file.
 */
#ifndef EMBEDDEDFILEERRORHANDLERSCPP_H
#define EMBEDDEDFILEERRORHANDLERSCPP_H
...
namespace bin2cpp
{
  ...
  const File & getErrorHandlersCppFile();
}; //bin2cpp

#endif //EMBEDDEDFILEERRORHANDLERSCPP_H
