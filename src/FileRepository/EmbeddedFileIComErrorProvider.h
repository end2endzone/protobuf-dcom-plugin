 ...
 * Source code for file 'IComErrorProvider.h', last modified 1552228002.
 * Do not modify this file.
 */
#ifndef EMBEDDEDFILEICOMERRORPROVIDER_H
#define EMBEDDEDFILEICOMERRORPROVIDER_H
...
namespace bin2cpp
{
  ...
  const File & getIComErrorProviderFile();
}; //bin2cpp

#endif //EMBEDDEDFILEICOMERRORPROVIDER_H
