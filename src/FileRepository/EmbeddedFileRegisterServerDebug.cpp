...
namespace bin2cpp
{
  ...
  {
  public:
    RegisterServerDebugFile() {}
    ~RegisterServerDebugFile() {}
    virtual size_t getSize() { return 76; }
    virtual size_t getSegmentSize() { return 200; }
    virtual size_t getNumSegments() { return 1; }
    virtual const char * getFilename() { return "RegisterServerDebug.bat"; }
    virtual const char * getSegment(size_t iIndex, size_t & oLength)
    {
      ...
      oLength = 76;
      buffer = "@echo off\x0d\x0a\".\\Debug\\DCOMPLUGIN_COMPONENT_NAMEServer.exe\" /regserver\x0d\012pause\x0d\x0a"; if (iIndex == index) return buffer; index++;
      oLength = 0;
      return NULL;
    }
    virtual const char * getMd5() { return "30426c8f39ed615e9f8cfd4ac047f606"; }
  ...
  File & getRegisterServerDebugFile() { static RegisterServerDebugFile _instance; return _instance; }
}; //bin2cpp
