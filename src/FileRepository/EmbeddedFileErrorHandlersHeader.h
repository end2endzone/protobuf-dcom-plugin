 ...
 */
#ifndef EMBEDDEDFILEERRORHANDLERSHEADER_H
#define EMBEDDEDFILEERRORHANDLERSHEADER_H
...
namespace bin2cpp
{
  ...
  const File & getErrorHandlersHeaderFile();
}; //bin2cpp

#endif //EMBEDDEDFILEERRORHANDLERSHEADER_H
