 ...
 */
#ifndef EMBEDDEDFILEREGISTERSERVERRELEASE_H
#define EMBEDDEDFILEREGISTERSERVERRELEASE_H
...
namespace bin2cpp
{
  ...
  const File & getRegisterServerReleaseFile();
}; //bin2cpp

#endif //EMBEDDEDFILEREGISTERSERVERRELEASE_H
