 ...
 * Source code for file 'MessageSerializer.h', last modified 1552228002.
 * Do not modify this file.
 */
#ifndef EMBEDDEDFILEMESSAGESERIALIZERHEADER_H
#define EMBEDDEDFILEMESSAGESERIALIZERHEADER_H
...
namespace bin2cpp
{
  ...
  const File & getMessageSerializerHeaderFile();
}; //bin2cpp

#endif //EMBEDDEDFILEMESSAGESERIALIZERHEADER_H
