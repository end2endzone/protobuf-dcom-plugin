...
HRESULT Variant2ByteArray(VARIANT & iVar, testdemo::VariantFlavor & oVariantFlavor, std::string & oData)
{
...
HRESULT ByteArray2Variant(const std::string & iData, const testdemo::VariantFlavor & iVariantFlavor, VARIANT & oVar)
{
  switch(iVariantFlavor)
  {
  case testdemo::CPLUSPLUS:
    {
...
///
HRESULT SerializeMessageToVariant(const google::protobuf::MessageLite & iMsg, const testdemo::VariantFlavor & iVariantFlavor, VARIANT & oVar)
{
  std::string data;
...
///
HRESULT DeserializeVariantToMessage(VARIANT & iVar, google::protobuf::MessageLite & oMsg, testdemo::VariantFlavor & oVariantFlavor)
{
  std::string data;
