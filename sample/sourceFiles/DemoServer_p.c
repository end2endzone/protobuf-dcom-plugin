...
extern const MIDL_SERVER_INFO IDemoServer_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IDemoServer_ProxyInfo;
...
/* Object interface: IDemoServer, ver. 0.0,
   GUID={0x7F24AABF,0xC822,0x4c18,{0x94,0x32,0x21,0x43,0x32,0x08,0xF4,0xDC}} */

#pragma code_seg(".orpc")
static const unsigned short IDemoServer_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IDemoServer_ProxyInfo =
    {
    &Object_StubDesc,
    DemoServer__MIDL_ProcFormatString.Format,
    &IDemoServer_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IDemoServer_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    DemoServer__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(9) _IDemoServerProxyVtbl = 
{
    &IDemoServer_ProxyInfo,
    &IID_IDemoServer,
    ...
    (void *) (INT_PTR) -1 /* IDemoServer::GetSequentialNumber */ ,
    (void *) (INT_PTR) -1 /* IDemoServer::Hello */
};


static const PRPC_STUB_FUNCTION IDemoServer_table[] =
{
...
CInterfaceStubVtbl _IDemoServerStubVtbl =
{
    &IID_IDemoServer,
    &IDemoServer_ServerInfo,
    9,
    &IDemoServer_table[-3],
...
const CInterfaceProxyVtbl * const _DemoServer_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IDemoServerProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _DemoServer_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IDemoServerStubVtbl,
    0
};
...
const IID *  const _DemoServer_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
